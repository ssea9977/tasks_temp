...
if __name__ == "__main__":
    ...
    value.to_csv('/root/scripts/database/zabbix/zabbix_values_5g.csv', header=True, index=False, columns=['date', 'time', 'host_id', 'temperature'])
    os.system('/root/scripts/database/zabbix/insert_values_5g.sh')